...
export default function MenuBrowser({ mode }) {
  ...
  // Every time a specific category is picked from the filter bar, land at
  // the top of that category's section instead of wherever the previous
  // scroll position happens to fall on the new (often shorter/taller) list.
  useEffect(() => {
    if (activeCategory === 'all') return
    const el = document.getElementById(`menu-${activeCategory}`)
